...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background smooth-transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default: "bg-primary text-primary-foreground hover:bg-primary-dark medical-shadow",
        medical: "medical-gradient text-primary-foreground hover:bg-primary-light elevation-shadow",
        healing: "healing-gradient text-healing-foreground hover:bg-healing-light card-shadow",
        emergency: "bg-destructive text-destructive-foreground hover:bg-destructive/90 elevation-shadow animate-pulse",
